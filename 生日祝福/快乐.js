...
(function(e, t) {
    ...
    function H() {
        N.addEventListener ? (N.removeEventListener("DOMContentLoaded", B, !1),
        e.removeEventListener("load", B, !1)) : (N.detachEvent("onreadystatechange", B),
    ...
    function Jt(e, t) {
        ...
        for (; o < u; o++) {
            ...
            r.style.display === "" && $(r) && (s[o] = p._data(r, "olddisplay", _t(r.nodeName)))) : s[o] || (i = $(r),
            (n && n !== "none" || !i) && p._data(r, "olddisplay", i ? n : p.css(r, "display")))
        }
        for (o = 0; o < u; o++) {
            r = e[o];
            if (!r.style)
    ...
    function Qt(e, t, n, r, i) {
        var s = n === (r ? "border" : "content") ? 4 : t === "width" ? 1 : 0
          , o = 0;
        for (; s < 4; s += 2)
            n === "margin" && (o += p.css(e, n + V[s], !0, i)),
            r ? (n === "content" && (o -= p.css(e, "padding" + V[s], !0, i)),
            n !== "margin" && (o -= p.css(e, "border" + V[s] + "Width", !0, i))) : (o += p.css(e, "padding" + V[s], !0, i),
            n !== "padding" && (o += p.css(e, "border" + V[s] + "Width", !0, i)));
        return o
    }
    function Gt(e, t, n) {
        var r = !0
    ...
    function ln(e, t, n) {
        ...
        l = _t(e.nodeName),
        f === "none" && (f = l),
        f === "inline" && p.css(e, "float") === "none" && (!c.inlineBlockNeedsLayout || l === "inline" ? v.display = "inline-block" : v.zoom = 1)),
        n.overflow && (v.overflow = "hidden",
        c.shrinkWrapBlocks() || h.always(function() {
        ...
        for (; u < a; u++)
            if ((i = arguments[u]) != null)
                for (r in i) {
                    ...
                    if (o === n)
                        continue;
                    f && n && (p.isPlainObject(n) || (t = p.isArray(n))) ? (t ? (t = !1,
                    s = e && p.isArray(e) ? e : []) : s = e && p.isPlainObject(e) ? e : {},
    ...
    p.filter = function(e, t, n) {
        var r = t[0];
        return n && (e = ":not(" + e + ")"),
        t.length === 1 && r.nodeType === 1 ? p.find.matchesSelector(r, e) ? [r] : [] : p.find.matches(e, p.grep(t, function(e) {
            return e.nodeType === 1
        }))
    }
    ,
    ...
    var T, N = e.document, C = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, k = p.fn.init = function(e, t) {
        ...
        this.length = 1,
        this) : p.isFunction(e) ? typeof T.ready != "undefined" ? T.ready(e) : e(p) : (e.selector !== undefined && (this.selector = e.selector,
    ...
    p.each({
        ...
        p.fn[e] = function(n, r) {
            ...
            this.length > 1 && (A[e] || (i = p.unique(i)),
            L.test(e) && (i = i.reverse())),
            this.pushStack(i)
        }
    });
    var M = /\S+/g
            ...
            if (e === undefined) {
                if (this.length) {
                    ...
                    if (s.nodeType === 1 && !p._data(s, "parsedAttrs")) {
                        ...
                        while (n--)
                            r = o[n].name,
                            r.indexOf("data-") === 0 && (r = p.camelCase(r.slice(5)),
                            R(s, r, i[r]));
    ...
    function() {
        ...
        for (t in {
            ...
            n = "on" + t,
            (c[t + "Bubbles"] = n in e) || (r.setAttribute(n, "t"),
    ...
    p.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            while (f--) {
                ...
                while (s--)
                    o = h[s],
                    (i || m === o.origType) && (!n || n.guid === o.guid) && (!u || u.test(o.namespace)) && (!r || r === o.selector || r === "**" && o.selector) && (h.splice(s, 1),
            ...
            p.isEmptyObject(l) && (delete g.handle,
        ...
        trigger: function(t, n, r, i) {
            ...
            while ((u = d[h++]) && !t.isPropagationStopped())
                ...
                s && s.apply(u, n),
                s = o && u[o],
                s && s.apply && p.acceptData(u) && (t.result = s.apply(u, n),
        ...
        mouseHooks: {
            ...
            filter: function(e, t) {
                ...
                return e.pageX == null && t.clientX != null && (r = e.target.ownerDocument || N,
                i = r.documentElement,
                n = r.body,
    ...
    p.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === undefined && (e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault()) ? tt : nt) : this.type = e,
        t && p.extend(this, t),
            ...
            for (; (r = e[u]) != null; u++)
                if (t || p.acceptData(r)) {
                    ...
                    if (o) {
                        ...
                        f[s] && (delete f[s],
                        l ? delete r[a] : typeof r.removeAttribute !== j ? r.removeAttribute(a) : r[a] = null,
                        n.push(s))
                    }
                }
        }
    ...
    p.fn.extend({
        ...
        remove: function(e, t) {
            ...
            for (; (n = r[i]) != null; i++)
                !t && n.nodeType === 1 && p.cleanData(Et(n)),
                n.parentNode && (t && p.contains(n.ownerDocument, n) && Ct(Et(n, "script")),
            ...
            return J(this, function(e) {
                ...
                if (typeof e == "string" && !pt.test(e) && (c.htmlSerialize || !ut.test(e)) && (c.leadingWhitespace || !at.test(e)) && !yt[(lt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            t = this[n] || {},
                            t.nodeType === 1 && (p.cleanData(Et(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (i) {}
                }
    ...
    (function() {
        ...
        c.shrinkWrapBlocks = function() {
            ...
            if (t == null) {
                ...
                t = !1,
                typeof i.style.zoom !== j && (i.style.cssText = r + ";width:1px;padding:1px;zoom:1",
                i.innerHTML = "<div></div>",
    ...
    Bt = function(e, t, n) {
        ...
        n && (o === "" && !p.contains(e.ownerDocument, e) && (o = p.style(e, t)),
        Pt.test(o) && Dt.test(t) && (r = u.width,
        i = u.minWidth,
        s = u.maxWidth,
    ...
    function() {
        function l() {
            ...
            s = !1,
            o = !0,
            e.getComputedStyle && (s = (e.getComputedStyle(n, null) || {}).top !== "1%",
    ...
    p.extend({
        ...
        style: function(e, t, n, r) {
            ...
            s = typeof n,
            s === "string" && (i = zt.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(p.css(e, t)),
            s = "number");
            if (n == null || n !== n)
                return;
    ...
    p.fn.extend({
        val: function(e) {
            ...
            if (!arguments.length) {
                if (i)
                    return t = p.valHooks[i.type] || p.valHooks[i.nodeName.toLowerCase()],
                    t && "get"in t && (n = t.get(i, "value")) !== undefined ? n : (n = i.value,
                    typeof n == "string" ? n.replace(pn, "") : n == null ? "" : n);
                return
            }
            ...
            this.each(function(n) {
                ...
                i == null ? i = "" : typeof i == "number" ? i += "" : p.isArray(i) && (i = p.map(i, function(e) {
                    return e == null ? "" : e + ""
                })),
    ...
    p.extend({
        attr: function(e, t, n) {
            ...
            if (n === undefined)
                return r && "get"in r && (i = r.get(e, t)) !== null ? i : (i = p.find.attr(e, t),
                i == null ? undefined : i);
            if (n !== null)
    ...
    p.extend({
        ...
        ajax: function(e, t) {
            ...
            l.crossDomain == null && (n = Pn.exec(l.url.toLowerCase()),
            ...
            i = l.url,
            l.hasContent || (l.data && (i = l.url += (Tn.test(i) ? "&" : "?") + l.data,
            delete l.data),
            l.cache === !1 && (l.url = An.test(i) ? i.replace(An, "$1_=" + xn++) : i + (Tn.test(i) ? "&" : "?") + "_=" + xn++)),
            l.ifModified && (p.lastModified[i] && E.setRequestHeader("If-Modified-Since", p.lastModified[i]),
    ...
    p.fn.load = function(e, t, n) {
        ...
        return u >= 0 && (r = e.slice(u, e.length),
        e = e.slice(0, u)),
        p.isFunction(t) ? (n = t,
    ...
    p.fn.extend({
        offset: function(e) {
            ...
            p.contains(t, i) ? (typeof i.getBoundingClientRect !== j && (r = i.getBoundingClientRect()),
            n = sr(s),
            {
        ...
        position: function() {
            ...
            return p.css(r, "position") === "fixed" ? t = r.getBoundingClientRect() : (e = this.offsetParent(),
            t = this.offset(),
        ...
        p.each({
            ...
            p.fn[r] = function(r, i) {
                ...
                return J(this, function(t, n, r) {
                    ...
                    Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : r === undefined ? p.css(t, n, o) : p.style(t, n, r, o)
